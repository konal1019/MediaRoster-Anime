import { status, initSlideshow, initFlashcardHover, randomAnime, initFilters, renderGenres, initSearch, displaySearchResults, applyFilters} from '../main.43892caf.js';
import { searchAnime, getTopRatedAnime, getMostPopularAnime, getGenres, genres } from '../api.6b09fcee.js';
import { createSection, createFlashcard } from './UIs.1e4f6117.js';
import { loadCSS, showLoader, hideLoader } from '../pages.c2bbb4e4.js'
import { escapeHTML } from './utils.3840e25b.js';

export async function loadSearchPage() {
    const currentHash = window.location.hash;
    loadCSS('./css/search.2883a058.css');
